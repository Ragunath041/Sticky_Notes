...
abstract class FlutterFlowTheme {
  ...
  late Color activateButtonBackground;
  late Color activateButtomText;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primaryBackground = const Color(0xFFE8EEF6);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0x4C4B39EF);
  late Color accent2 = const Color(0x4D39D2C0);
  late Color accent3 = const Color(0x4DEE8B60);
  late Color accent4 = const Color(0xFF57636C);
  late Color success = const Color(0xFF249689);
  late Color warning = const Color(0xFFF9CF58);
  late Color error = const Color(0xFFFF5963);
  late Color info = const Color(0xFFFFFFFF);

  late Color activateButtonBackground = Color(0xFF000000);
  late Color activateButtomText = Color(0xFFFFFFFF);
}
